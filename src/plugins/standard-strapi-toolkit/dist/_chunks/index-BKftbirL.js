...
const multiSelectRegisterAdmin = {
  ...
  components: {
    Input: async () => Promise.resolve().then(() => require("./input-y9BHAG4j.js"))
  },
  options: {
    base: [
      {
...
`;
const Icon$1 = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(IconBox$1, { hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsx(icons.BulletList, {}) });
};
...
`;
const Icon = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(IconBox, { hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsx(icons.GridFour, {}) });
};
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-BhC0WUgi.js"));
        return App;
      }
    });
