...
const multiSelectRegisterAdmin = {
  ...
  components: {
    Input: async () => Promise.resolve().then(() => require("./input-DgLJW9Hx.js"))
  },
  options: {
    base: [
      {
...
const iconPickerRegisterAdmin = {
  ...
  icon: Icon,
  components: {
    Input: async () => Promise.resolve().then(() => require("./input-DXTay7Hp.js"))
  }
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-lIs-8n_-.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CCVavKW8.js.map
