...
const multiSelectRegisterAdmin = {
  ...
  components: {
    Input: async () => Promise.resolve().then(() => require("./input-DOYsfAwg.js"))
  },
  options: {
    base: [
      {
...
const colorPickerRegisterAdmin = {
  ...
  icon: Icon$1,
  components: {
    Input: async () => Promise.resolve().then(() => require("./input-CnXVtu-R.js"))
  }
};
...
const iconPickerRegisterAdmin = {
  ...
  icon: Icon,
  components: {
    Input: async () => Promise.resolve().then(() => require("./input-C1KF3bh7.js"))
  }
};
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await Promise.resolve().then(() => require("./App-C0By84Du.js"));
        return App;
      }
    });
...
exports.index = index;
//# sourceMappingURL=index-CR4Ov9M7.js.map
